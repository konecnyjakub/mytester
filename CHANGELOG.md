...
- deprecated Environment::NAME, Environment::printLine(), Environment::getShouldFail(), Environment::setShouldFail(), Environment::$shouldFail, Environment::VERSION, Environment::$currentJob
