...
- added events ExtensionsLoaded, RunnerStarted, RunnerFinished, TestStarted, TestFinished, TestPassed, TestPassedWithWarning, TestFailed, TestSkipped and DeprecationTriggered
...
- BC break: removed constants AnnotationsSkipChecker::ANNOTATION_NAME and ITestSuitesFinder::FILENAME_SUFFIX
